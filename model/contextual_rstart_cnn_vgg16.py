...
from model.contextual_rstar_cnn import RStarCNN
...
#         print(weighted_feat.shape) # 1280 * 4096
        ...
        extended_features = t.zeros(primary_features.shape[0], 11, 4096)
#         if use_gpu:
        ...
        # extended_features = t.cat((primary_features, weighted_feat), dim=0)
